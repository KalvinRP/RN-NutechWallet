...
export default function Profile(props) {
    const { styles, theme, setTheme } = useContext(MyContext)
    ...
    return (
        <>
            ...
            <Actionsheet isOpen={setting} onClose={() => handleSet(false)}>
                <Actionsheet.Content>
                    <Actionsheet.Item onPress={() => setTheme(theme === "dark" ? "light" : "dark")}>{theme === "dark" ? "Beralih ke mode terang" : "Beralih ke mode gelap"}</Actionsheet.Item>
